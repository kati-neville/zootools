	...
	return (
		<CardWrapper
			...
			{/* <Table>
				<TableHead>
					<TableRow>
						<Heading fontSize="1.4rem" fontWeight="600" color={colors.zooBlack}>
							Summary
						</Heading>
						<Heading fontSize="1.4rem" fontWeight="600" color={colors.zooBlack}>
							Recommendation
					...
					<TableRow>
						<TableData as={"td"}>
							<Flex justifycontent="flex-start">
								...
								<Bold>Sign ups are slowing down.</Bold> &nbsp; -5% new than last
								week
							</Flex>
						</TableData>
						<TableData as={"td"}>
					...
					<TableRow>
						<TableData as={"td"}>
							<Flex justifycontent="flex-start">
								...
								<Bold>80%</Bold> &nbsp; of your signups were invited by other
								members
							</Flex>
						</TableData>
						<TableData as={"td"}>
